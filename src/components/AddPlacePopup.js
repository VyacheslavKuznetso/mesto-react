...
function AddPlacePopup(props) {
    ...
    return (
        <PopupWithForm name="add-form" isOpen={props.isOpen} onClose={props.onClose} handleSubmit={handleSubmit} nameId="addForm" formId="userImg" title="Новое место" submitButtonLabel="Создать" >
